...
export default function Partners() {
  ...
  const partners =[{src:partner1},{src:partner2},{src:partner3},{src:partner4},{src:partner5},{src:partner6},{src:partner7},{src:partner8},{src:partner9},{src:partner10}]
  let amount=9
...
amount=6
    ...
    >
      {
        partners.map((item)=>(
          <SwiperSlide key={item.src} className="swiper_partners"> <div className="swiper_partners"><img src={item.src} alt={item.src}/></div></SwiperSlide>
        ))
      }
